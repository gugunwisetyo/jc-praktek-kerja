...
import com.juaracoding.pages.ReportAbsenMasukPage;
...
public class ReportAbsenMasukTest {
    ...
    private static ReportAbsenMasukPage reportAbsenMasukPage = new ReportAbsenMasukPage();
    ...
    public void user_login_as_admin(){
        reportAbsenMasukPage.setUsername("admin_tms");
        reportAbsenMasukPage.setPassword("d1k4@passw0rd");
        DriverSingleton.delay(3);
        reportAbsenMasukPage.setLoginBtn();
    ...
    public void user_click_privilege_report_absen_masuk(){
        reportAbsenMasukPage.setPrivilegeReportAbsen();
    ...
    public void user_click_menu_report_absen_masuk(){
        reportAbsenMasukPage.setMenuReportAbsenMasuk();
    ...
    public void user_get_text_header_report_absen_masuk(){
        DriverSingleton.delay(3);
        Assert.assertEquals(reportAbsenMasukPage.getHeader(),"Report Absen Masuk");
    ...
    public void user_input_valid_position_masuk(){
        reportAbsenMasukPage.setPosition("ALL");
    ...
    public void user_input_valid_branch_masuk(){
        reportAbsenMasukPage.setBranch("ALL");
    ...
    public void user_input_valid_unit_masuk(){
        reportAbsenMasukPage.setUnit("ALL");
    ...
    public void user_input_valid_start_date_masuk(){
        reportAbsenMasukPage.setStartDate("2023-10-31");
        flagDate = "2023-10-31";
    ...
    public void user_input_invalid_start_date_masuk(){
        reportAbsenMasukPage.setStartDate("");
        flagDate = "";
    ...
    public void user_input_valid_end_date_masuk(){
        reportAbsenMasukPage.setEndDate("2023-11-14");
    ...
    public void user_click_export_data_absen_masuk(){
        reportAbsenMasukPage.setExportBtn();
...
//        }
    ...
    public void user_click_profile_button_report_masuk(){
        reportAbsenMasukPage.setProfile();
    ...
    public void user_click_logout_button_report_masuk(){
        reportAbsenMasukPage.setLogoutBtn();
    ...
    public void user_get_data_table_report_masuk(){
        if(reportAbsenMasukPage.getDataTable().equals("dataTables_empty")){
