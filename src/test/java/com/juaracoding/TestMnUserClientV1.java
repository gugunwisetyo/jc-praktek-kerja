...
public class TestMnUserClientV1 {
    ...
    public void user_input_email_new() {
        mnUserClientV1.getInputEmail("automation13@test.com");
    ...
    public void user_input_full_name_new(){
        mnUserClientV1.getInputName("automation test13 ");
   ...
   //button cancel
    ...
    public void user_get_text_message_total_list_data(){
        ...
        Assert.assertEquals(mnUserClientV1.getTxtTotalList(),"Showing 1 to 10 of 80 entries");
